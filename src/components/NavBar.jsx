        ...
        <nav className="top-0 shadow-xl p-2 w-full lg:flex flex-row justify-between items-center">
            ...
            {!props.loggedIn ?
                ...
                <div className="ml-24 lg:inline mt-6 mb-4">
                    <button ref={menuRef} onClick={handleMenuToggle} className="flex items-center space-x-2 text-white bg-purple-100 hover:bg-green-500 hover:text-white px-3 py-2 rounded-md focus:outline-none">
                        ...
                        <span className="mr-4 text-black hover:text-white font-semibold">{props.userName}</span>
