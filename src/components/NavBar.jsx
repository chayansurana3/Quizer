...
export default function NavBar(props) {
    ...
    return !props.display ? null : (
        <nav className="top-0 fixed shadow-xl p-2 w-full lg:flex flex-row justify-between items-center">
            ...
            {!props.loggedIn ?
                ...
                :
                <div className="relative lg:inline ml-36 mt-6 mb-4 mr-4">
                    ...
                    {showMenu && (
                        <div className="absolute right-16 lg:right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1">
