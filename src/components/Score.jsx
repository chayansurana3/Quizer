...
export default function Score({ quizName, userScore, totalQuestions, totalTimeTaken, totalTime, showSolutions }){
    ...
    return (
        <div className="text-center score-container border border-gray-300 p-4 rounded-lg shadow-md">
            ...
            <button className="mx-auto block px-6 py-3 bg-blue-500 text-white font-semibold rounded-md shadow-md hover:bg-blue-600 transition-colors duration-300" onClick={showSolutions}>Check Solutions</button>
        </div>
    );
};